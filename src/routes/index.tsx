  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6 pt-8 pb-10 md:pt-16 md:pb-20 lg:pt-24 lg:pb-28 relative">
        {/* Mobile: image beside title, no card overlay */}
        <div className="flex gap-4 lg:contents">
          ...
          {/* Mobile: image beside title, no overlay card */}
          <div className="lg:hidden flex-shrink-0 w-28 self-start mt-8">
            <img
              src={heroImg}
        ...
        {/* Desktop: full grid layout with image column and card overlay */}
